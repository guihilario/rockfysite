...
export default async function HospedagemElementorPro() {
  ...
  return (
    <PaginaServico
      ...
      descricao="Licença Elementor Pro oficial inclusa e ativada automaticamente na sua conta. Servidor otimizado, conta cPanel isolada, migração grátis e sem fidelidade."
      hero={<HeroElementor />}
