        ...
        <div class="split split--rev">
          <div>
            ...
            <p class="para">
              ...
              resolve. Você foca em gerar valor para o seu cliente, e a gente da
              sua infra.
            </p>
        ...
        {passos && (
          <ol class="steps">
            <li class="step">
              ...
              <h3 class="step__t">Conecte o repositório ou envie o projeto</h3>
              <p class="step__d">
            ...
            <li class="step">
              ...
              <p class="step__d">Seu projeto no ar, com endereço definitivo.</p>
            </li>
          </ol>
        )}
      </section>
