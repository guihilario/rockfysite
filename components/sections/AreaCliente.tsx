      ...
      <section class="section dotted">
        <div class="split split--cta-last">
          <div>
            ...
            <p class="para">
              Projetamos um painel pensando em você, que tem clientes e projetos
              diversos. Serviços, finanças e suporte. Integre o seu gateway de
              pagamento e gerencie num só lugar.
            </p>
